...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"vsphere_license": config.IdentifierFromProvider,
        ...
        "vsphere_host": config.ParameterAsIdentifier("hostname"),
...
//        "vsphere_tag": config.TemplatedStringAsIdentifier("name", "'{\"category_name\": \"{{ .parameter.category_id }}\", \"tag_name\": \"{{ .externalName }}\"}'"),
        ...
        "vsphere_distributed_virtual_switch": config.TemplatedStringAsIdentifier("name", "{{ .parameter.datacenter_id }}/{{ .externalName }}"),
        "vsphere_distributed_port_group": config.TemplatedStringAsIdentifier("name", "{{ .parameter.datacenter_id }}/{{ .externalName }}"),
        ...
        "vsphere_datastore_cluster": config.TemplatedStringAsIdentifier("name","{{ .parameter.folder }}/{{ .externalName }}"),
        "vsphere_compute_cluster": config.TemplatedStringAsIdentifier("name","{{ .parameter.folder }}/{{ .externalName }}"),
        ...
        "vsphere_virtual_machine": config.TemplatedStringAsIdentifier("name","{{ .parameter.folder }}/{{ .externalName }}"),
